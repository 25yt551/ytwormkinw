 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    U.push(["jsl", function(a) {
        for (var b in a)
            if (Object.prototype.hasOwnProperty.call(a, b)) {
                var c = a[b];
                typeof c == "object" ? M[b] = H(M, b, []).concat(c) : H(M, b, c)
            }
        if (b = a.u)
            a = H(M, "us", []),
            a.push(b),
    ...
    var oa = /^(\/[a-zA-Z0-9_\-]+)+$/
      ...
      , wa = function(a, b, c, d, e) {
        ...
        b = p;
        c = b.match(ta);
        (d = b.match(ua)) && d.length === 1 && va.test(b) && c && c.length === 1 || V("failed sanity: " + a);
        try {
            a = "?";
            if (e && e.length > 0) {
                c = b = 0;
      ...
      , va = /^https?:\/\/[a-z0-9_.-]+\.google(rs)?\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/
      , ua = /\/cb=/g
      , ta = /\/\//g;
    ...
    ;
    var X = decodeURI("%73cript"), Aa = /^[-+_0-9\/A-Za-z]+={0,2}$/, Ba = function(a, b) {
        ...
        var a = M.nonce;
        return a !== void 0 ? a && a === String(a) && a.match(Aa) ? a : M.nonce = null : F.querySelector ? (a = F.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "",
        a && a === String(a) && a.match(Aa) ? M.nonce = a : M.nonce = null) : null : null
    }, Ea = function(a) {
        ...
        b.async = "true";
        (a = F.getElementsByTagName(X)[0]) ? a.parentNode.insertBefore(b, a) : (F.head || F.body || F.documentElement).appendChild(b)
    }, Ga = function(a, b, c) {
        Fa(function() {
            var d = b === N() ? H(J, "_", I()) : I();
            d = H(O(b), "_", d);
    ...
    window.gapi.load("", {
        ...
        _c: {
            ...
            jsl: {
                ...
                h: "m;/_/scs/abc-static/_/js/k=gapi.lb.en.aua8ukEWe74.O/d=1/rs=AHpOoo-9vDKdscewy8drQ984EeTo0iOz2A/m=__features__",
